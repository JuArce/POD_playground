...
public class StreamGenerateAndFinalizeTest {
    ...
    public final void iterate_all_match() {
        ...
        assertEquals("Use all match to uneven", false, numbers.allMatch(x -> x == 0));
    }
    ...
    public final void concat_min_max() {
        ...
        assertEquals("Should return the min", new Integer(31), numbersSupplier.get().min(Comparator.naturalOrder()).get()); // check Comparator#naturalOrder
        assertEquals("Should return the max", new Integer(33), numbersSupplier.get().max(Comparator.naturalOrder()).get()); // check Comparator#naturalOrder
    ...
    public final void double_stream_sum() {
        ...
        assertEquals("should get the  sum of the values", 2.3, numbers.average().getAsDouble(), 0.001);
    }
}
