package ar.edu.itba.pod.j8.tp.tp1.ej2.model;
...
public class Country {
    ...
    public Country(final String name, final Continent continent, final long population, final LocalDate independenceDay) {
